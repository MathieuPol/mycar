 ...
 */
final class Version20220827125314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, brand_id INT NOT NULL, modele VARCHAR(80) NOT NULL, releasedate DATE NOT NULL, fuel VARCHAR(50) NOT NULL, door SMALLINT NOT NULL, etat VARCHAR(40) NOT NULL, prix INT NOT NULL, slug VARCHAR(120) DEFAULT NULL, INDEX IDX_773DE69D44F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
