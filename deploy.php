...
// ---------------------------------------------------------------------------
set("env_database", "mysql://admin:admin@127.0.0.1:3306/mycar?serverVersion=mariadb-10.3.34");
...
// TODO
set('remote_server_target_repository', '/var/www/html/mycar');

// Adresse du dépôt Github contenant le code source du projet 
// TODO
set('repository', 'git@github.com:MathieuPol/mycar.git');
...
task('init:config:write:prod', function() {
    ...
    run('echo "MYSLUGGER_LOWER=true" >> {{remote_server_target_repository}}/shared/.env.local');
});
